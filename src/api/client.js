...
export const classroomAPI = {
  ...
  manageStudents: (id, data) => apiClient.post(`/classrooms/${id}/students`, data),
};

export const attendanceAPI = {
  get: (classroomId, date) => apiClient.get(`/attendance/${classroomId}`, { params: { date } }),
  save: (classroomId, data) => apiClient.post(`/attendance/${classroomId}`, data),
  submit: (classroomId, data) => apiClient.post(`/attendance/${classroomId}/submit`, data),
  getStudentMonthly: (studentId, month, year) => apiClient.get(`/attendance/student/${studentId}`, { params: { month, year } }),
...
export const examAPI = {
  ...
  getStudentResults: (studentId) => apiClient.get(`/exams/results/${studentId}`),
};

export const feeAPI = {
  getAll: (params) => apiClient.get('/fees', { params }),
  create: (data) => apiClient.post('/fees', data),
  collectInstallment: (id, data) => apiClient.patch(`/fees/${id}/collect`, data),
...
export const studentAPI = {
  ...
  getBirthdays: (classroomId) => apiClient.get(`/students/birthdays/${classroomId}`),
