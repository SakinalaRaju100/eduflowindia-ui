...
const PAGE_TITLES = {
  ...
  '/superadmin/home': 'Home',
  '/principal': 'Dashboard',
  '/principal/home': 'Home',
  '/principal/profile': 'Institution Profile',
  ...
  '/principal/calendar': 'Institution Calendar',
  '/principal/leaves': 'Leave Management',
  '/principal/announcements': 'Announcements',
  '/principal/inquiries': 'Student Inquiries',
  ...
  '/student/Institution': 'Institution Info',
  ...
  '/parent/home': 'Home',
  '/parent': 'My Children',
  '/parent/Institution': 'Institution Info',
  '/parent/child/:id/Institution': 'Institution Info',
