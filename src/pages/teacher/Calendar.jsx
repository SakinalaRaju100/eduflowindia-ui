...
export default function TeacherCalendar() {
  ...
  const getDayItems = (day) => {
    ...
    const exs = exams.filter((e) =>
      e.subjects?.some((s) => s.date && isSameDay(new Date(s.date), day)),
    );
  ...
  return (
    <Box>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        ...
        <Button variant="contained" startIcon={<Add />} onClick={() => setLeaveOpen(true)}>
          Apply Leave
        </Button>
      </Box>
                        ...
                        bgcolor: isToday
                          ...
                          : canApplyLeave
                            ...
                            : day.getDay() === 0
                              ? 'action.hover'
                              : 'transparent',
                        transform: canApplyLeave ? 'scale(1.02)' : 'none',
                      },
      ...
      >
        <CardContent sx={{ p: 3 }}>
          ...
          <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
            {events.length === 0 && exams.length === 0 ? (
